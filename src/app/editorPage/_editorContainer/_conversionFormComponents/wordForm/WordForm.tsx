...
import { VStack, HStack, Box, Text, Input, Select, NumberInput, NumberInputField, NumberInputStepper, NumberIncrementStepper, NumberDecrementStepper, IconButton } from '@chakra-ui/react';
...
const WordForm: React.FC<WordFormProps> = ({ word, caseFormat, inputOrder,id, onWordChange, onCaseFormatChange, onInputOrderChange, onRemove }) => (
