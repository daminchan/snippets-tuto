    ...
    const updates = [
        {
          date: '2024/03/30',
          details: [
            { title: '更新', description: 'ユーザーの操作を直感的にサポートする為、アニメーションアイコンを導入しました' },
            { title: '更新', description: 'アップデートや不具合関連を表示するようにしました。' },
            { title: '対応中', description: '変換が完了していないのに変換ボタンを押せる不具合' },
            { title: '対応中', description: 'スニペット構文から他のスニペット構文に変換する際エラーがでる不具合' },
            { title: '対応中', description: '本番ページでのStepUpIconの初期位置が意図しない場所に表示する為、遅らせて表示する事で対応中' },
        ...
        },
        {
          ...
          details: [
            ...
            { title: 'アップデート予定', description: '本番ページ：オールクリアボタンの追加' },
          ],
        },
      ];
