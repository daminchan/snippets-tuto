...
const DemoCodeDisplayComponents: React.FC<PreviewContainerProps> = ({
  onButtonClick,
  onOverLay,
  onAppPageLinkButton,
}) => {
        ...
        <Box width="700px">
          ...
          >
            ...
            >
              ...
              <DemoConversionFormComponents
                updateCode={updateCode}
                isDisabled={isButtonDisabled}
                isMessageVisible={isMessageVisible}
              />
              <DemoCodeEditorComponent code={code} setCode={setCode} />
            </Box>
          </motion.div>
        </Box>
        <Box width="700px">
          ...
          >
            <Box flex="1" shadow="base" borderColor="gray.200" borderRadius="15px" p={3} m={5} bg="white">
              ...
              />
              <DemoCodeEditorComponent code={rightCode} setCode={setRightCode} />
            </Box>
          </motion.div>
        </Box>
      </Box>
